...
if (year%4==0):
  if(year%100==0):#Both year %100 and year%400 cannot be cleanly divisible at time then results in not a leap year
    if(year%400==0):
      print("Leap year")
    else:
      print("Not leap year")
